      ...
      <Container style={{ position: 'relative', zIndex: 1 }}>
        <Row className="text-center text-white">
          <Col>
            ...
            <Button variant="primary" size="lg" className="animated fadeIn" style={{ animationDelay: '1s' }}
...
const ContactForm = () => {
  const handleSubmit = async (event) => {
    ...
    // try {
    //   const response = await axios.post('http://localhost:8080/submit-contact-form', formData);
